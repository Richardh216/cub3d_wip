...
SRC := main.c error.c parse.c parse_color.c get_next_line.c get_next_line_utils.c parse_path.c parse_utils.c parse_map.c render.c render_utils.c hooks.c actions.c\
